  ...
  return (
    <section className="flex items-center justify-center h-screen mx-auto">
      <div className="flex flex-col items-center justify-center py-20 leading-tight">
        ...
        <h2 className="text-[#64748B] text-lg pb-6 font-semibold tracking-tight italic">"I uncover patterns, build visual stories, and help transform data into confident decisions"</h2>
